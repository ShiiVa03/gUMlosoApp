...
public class MyRecyclerViewAdapterManager extends RecyclerView.Adapter<MyRecyclerViewAdapterManager.ViewHolder> {
    ...
    MyRecyclerViewAdapterManager(Context context, List<Restaurant> data) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        ViewHolder(View itemView) {
            super(itemView);
            nameView = itemView.findViewById(R.id.txt_restaurant);
